...
do
    ...
    DIR=results/distill/output
    NAME=vgg16_${DATASET_ABBR}_reinit_lr${lr}_iter${iter}_feat${lmda}_wd${wd}_mmt${mmt}_${id}
    TEACHER_DIR=results/finetune/vgg16/feat0/vgg16_${DATASET_ABBR}_lr5e-3_iter30000_wd1e-4_mmt0_1
